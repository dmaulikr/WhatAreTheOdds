//
//  TransitionManagerRightLeft.swift
//  WhatAreTheOdds
//
//  Created by Noah Bragg on 12/15/14.
...
class TransitionManagerRightLeft: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate  {
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        //these are for a cooler scroll in transition
